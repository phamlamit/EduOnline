...
public class LectureController {
    ...
    public ResponseEntity<?> getById(@PathVariable("lectureId") int id){
    ...
    @Admin
    @DeleteMapping("/lecture/delete/{lectureId}")
    public ResponseEntity<?> delete(@PathVariable("lectureId") int id){
